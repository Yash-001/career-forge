...
/**
 * HTTP request body for POST /api/v1/ai/resumes/{resumeId}/versions/{versionId}/tailor.
 * Only the job description is accepted from the client.
 * Resume bullets and skills are populated server-side from the authenticated user's resume version.
 */
